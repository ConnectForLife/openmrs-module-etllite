 ...
 * @author nanakapa
 */
@Api(value = "Settings", description = "REST API for accessing ETL Lite settings")
...
public class ConfigController extends RestController {
    ...
    /**
     * This method tests the specified ETL database connectivity by using the parameters defined while creating the ETL database settings.
     *
    ...
    @ApiOperation(value = "Test a ETL database connectivity",
            notes = "Return true if the specified ETL database connection is successful, false if not",
            response = Boolean.class)
    @ApiResponses(value = {
            @ApiResponse(code = HttpURLConnection.HTTP_OK, message = "Connectivity to the source database is successful"),
            @ApiResponse(code = HttpURLConnection.HTTP_INTERNAL_ERROR, message = "Connectivity to the source database is not successful")})
    ...
    @ApiResponses(value = {
            @ApiResponse(code = HttpURLConnection.HTTP_OK, message = "Successful retrieval of source database settings")})
    @ResponseStatus(HttpStatus.OK)
    @ResponseBody
    ...
    @ApiOperation(value = "Create or Update a source database settings and spring services",
            notes = "Create or Update a source database settings and spring services",
            response = ConfigResponseWrapper.class)
    @ApiResponses(value = {
            @ApiResponse(code = HttpURLConnection.HTTP_OK, message = "On successful update of the source database settings")})
    @ResponseStatus(HttpStatus.OK)
    @ResponseBody
    public ConfigResponseWrapper updateConfigs(
            @ApiParam(name = "configRequestWrapper", value = "Details of source database configurations and spring services to be created or updated",
                    required = true) @RequestBody ConfigRequestWrapper configRequestWrapper) {
        List<ConfigResponse> configResponses = new ArrayList<>();
        ConfigResponseWrapper configResponseWrapper = new ConfigResponseWrapper();
    ...
    @ApiOperation(value = "Deletes a specific source database settings",
            notes = "Deletes a specific source database settings")
    @ApiResponses(value = {
            @ApiResponse(code = HttpURLConnection.HTTP_OK, message = "Successful deletion of the source database settings")})
    @ResponseStatus(HttpStatus.OK)
    @ResponseBody
    public void delete(
            @ApiParam(name = "name", value = "Name of the source database settings to be deleted", required = true)
            @PathVariable(value = "name") String name) {
    ...
    @ApiOperation(value = "Delete all source database settings",
            notes = "Delete all source database settings")
    @ApiResponses(value = {
