 ...
 * @author nanakapa
 */
public class ETLServiceBundleIT extends BaseModuleContextSensitiveTest {
    ...
    public void shouldExtractData() throws MappingNotFoundException, IOException {
        ...
        assertThat(rows.get(0).get("date_created").toString(), is(LOCATION_DATE_CREATED.toString()));
    }
