 ...
 * @author nanakapa
 */
public class MappingServiceBundleIT extends BaseModuleContextSensitiveTest {
    ...
    private static final Date LOCATION_DATE_CREATED = new Date("2005-09-22 00:00:00.0");
    ...
    public void shouldTestMapping() throws MappingAlreadyExistsException, ETLException, MappingNotFoundException,
        ...
        assertThat(testData.get("extracted").get(0).get("date_created").toString(), is(LOCATION_DATE_CREATED.toString()));
